...
const IncomingCall: React.FC<IncomingCallProps> = ({
  ...
  return (
    <div
      className="absolute inset-0 bg-gray-950/80 backdrop-blur-2xl flex flex-col items-center justify-center gap-8 z-50 animate-fade-in"
      role="alertdialog"
      aria-labelledby="incoming-call-title"
    >
      <div className="text-center">
        <h2 id="incoming-call-title" className="text-3xl font-bold text-indigo-400">
          Incoming Call
        </h2>
